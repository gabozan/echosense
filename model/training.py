...
def convert_to_tflite(model, X_train):
    ...
    # Dataset para calibrar la cuantización (recorre 200 muestras)
    ...
    # Forzar operaciones de enteros (hace el modelo 4x más pequeño)
    converter.target_spec.supported_ops = [tf.lite.OpsSet.TFLITE_BUILTINS_INT8]
    
    # Mantener entrada/salida como float para que tu código C++ esp32 no cambie
    ...
    print(f"Modelo TFLite: {size_kb:.2f} KB (Debe ser < 40KB)")
